...
st.error(
    "**Disclaimer:** The suggestions provided by this application are **not** "
    "strict rules to follow and do **not** guarantee ideal financial outcomes. "
    "They are only possible advices generated by an AI model and should never be "
    "treated as professional financial guidance. Always consider your real personal "
    "situation, your actual needs, and the practical feasibility of any suggestion "
    "before acting on it. When in doubt, consult a qualified financial advisor.",
    icon="⚠️",
)
