...
class QueryAgent:
    ...
    SYSTEM_PROMPT = (
        ...
        "these three slots:\n"
        "  SLOT A — immediate situation: address the user's current debt, cash-flow, or expense problem.\n"
        ...
        "- Queries must be phrased as information-seeking phrases, NOT as questions.\n"
...
class AdvisorAgent:
    ...
    SYSTEM_PROMPT = (
        ...
        "1. **Key Recommendations** — 3 to 5 bullet points of actionable advice.\n"
        "2. **Relevant Principles** — briefly note which concepts from the sources apply.\n\n"
